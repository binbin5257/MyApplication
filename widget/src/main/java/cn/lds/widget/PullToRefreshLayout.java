...
public class PullToRefreshLayout extends RelativeLayout {
    ...
    private int headerBackgroundRes = R.color.bg_color;

    private int footerBackgroundRes = R.color.bg_color;
    ...
    public void refreshFinish(int refreshResult) {
        ...
        switch (refreshResult) {
            case SUCCEED:
                ...
                refreshStateImageView.setBackgroundResource(R.mipmap.bg_pull_succeed2);
                break;
            case FAIL:
            default:
                // 刷新失败
                ...
                refreshStateImageView.setBackgroundResource(R.mipmap.bg_pull_failed2);
                break;
        }
        if (pullDownY > 0) {
            // 刷新结果停留1秒
    ...
    public void loadmoreFinish(int refreshResult) {
        ...
        switch (refreshResult) {
            case SUCCEED:
                ...
                loadStateImageView.setBackgroundResource(R.mipmap.bg_pull_succeed2);
                break;
            case FAIL_NO_DATA:
            ...
            default:
                ...
                loadStateImageView.setBackgroundResource(R.mipmap.bg_pull_failed2);
                break;
        }
        if (pullUpY < 0) {
            // 刷新结果停留1秒
