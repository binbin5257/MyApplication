...
public class GroupRecyclerView extends RecyclerView {
    ...
    public GroupRecyclerView(Context context, @Nullable AttributeSet attrs) {
        ...
        mChildItemOffset = (int) array.getDimension(R.styleable.GroupRecyclerView_group_child_offset, 0);
        mTextColor = array.getColor(R.styleable.GroupRecyclerView_group_text_color, 0xFFFFFFFF);
        mGroutBackground = array.getColor(R.styleable.GroupRecyclerView_group_background, 0xff000000);
